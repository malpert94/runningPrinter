    ...
    def run(self):
        ...
        while comms:
            if primed and not purged:
                ...
                dis = input("Distance: ")
                command = "<?xml version='1.0' encoding='UTF-8'?><Rugged><Command><ID>" + str(comid+1) + "</ID><Text>" + text + "</Text><Lines>" + line + "</Lines><Direction>" + direct + "</Direction><Distance>" + dis + "</Distance><Begin>1</Begin></Command></Rugged>"
            ...
            while printing:
                continue
            comid += 1
            comms = int(input("Keep printing?(1/0)"))
        Activity = "INACTIVE"
